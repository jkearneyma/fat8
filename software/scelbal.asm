...
; source: https://www.willegal.net/scelbi/scelbal.html
...
; Memory Map:
SCELBAL	   EQU 03000
OLDPG1     EQU 20000		; writable area
OLDPG26    EQU (OLDPG1 &37400)+400
OLDPG27    EQU (OLDPG26&37400)+400
OLDPG57    EQU (OLDPG27&37400)+400
BGNPGRAM   EQU (OLDPG57/400)+1
ENDPGRAM   EQU 77
...
;system's display device. This routine calls a routine labeled CPRINT which must be provided
...
; fat8 character in call
CINP:      rst 4
           ori 200
           ret

CINPUT:    CAL CINP
; fat8 character out call
CPRINT:    ndi 177
           rst 3
           ori 200
           ret
